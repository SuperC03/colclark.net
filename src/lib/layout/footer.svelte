<footer
  class="mx-auto footer w-11/12 footer-horizontal border-t-4 bg-base-100 py-4 font-mono sm:max-w-4xl"
>
  <aside class="grid-flow-col items-center">
    <b class="text-lg">colclark</b>
  </aside>
  <nav class="grid-flow-col gap-4 place-self-center justify-self-end">
    <!-- https://icon-sets.iconify.design/ant-design -->
    <a title="Github" href="https://github.com/superc03" target="_blank" rel="noopener noreferrer">
      <svg
        xmlns="http://www.w3.org/2000/svg"
        class="h-8 w-8 fill-current hover:fill-primary"
        height="1024"
    ...
    <a
      title="LinkedIn"
      href="https://linkedin.com/in/superc03"
      target="_blank"
    ...
    <a title="Email" href="mailto:contact@colclark.net">
      <svg
        xmlns="http://www.w3.org/2000/svg"
        class="h-8 w-8 fill-current hover:fill-primary"
        viewBox="0 0 1024 1024"
